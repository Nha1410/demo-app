                        ...
                        >
                            ...
                            >
                                ...
                                <a
                                    ...
                                    class="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"
                                    ><i
                                        class="fab fa-angular mr-2 text-sm text-blueGray-400"
                                    ></i
                                ...
                                ><a
                                    ...
                                    class="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"
                                    ><i
                                        class="fab fa-react mr-2 text-sm text-blueGray-400"
                                    ></i
                                ...
                                ><a
                                    ...
                                    class="text-xs uppercase py-3 font-bold block text-blueGray-800 hover:text-blueGray-500"
                                    ><i
                                        class="fab fa-vuejs mr-2 text-sm text-blueGray-400"
                                    ></i
                                    ...
                                    >
                                        ...
                                        >
                                            <div class="flex-auto p-4">
                                                ...
                                                <p
                                                    class="text-sm text-blueGray-500 mt-4"
                                                >
                                                    <span
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <h2
                                                    class="text-xl font-semibold text-blueGray-800"
                                                >
                                                    Total orders
                                                </h2>
                                            </div>
                                ...
                                >
                                    <div class="px-6 py-4 border-0">
                                        ...
                                        >
                                            ...
                                            >
                                                <h3
                                                    class="font-bold text-lg text-blueGray-700"
                                                >
                                                    Page visits
                                                </h3>
                                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <i
                                                                class="fas fa-arrow-up mr-2 text-red-500"
                                                            ></i
                                                            >46,53%
                                                        </div>
                                                    </td>
                            ...
                            <div class="container mx-auto px-4">
                                ...
                                >
                                    <div class="w-full md:w-4/12 px-4">
                                        <div
                                            class="text-center mb-2 md:text-left md:mb-0"
                                        >
                                            <a
                                                href="https://www.creative-tim.com/?ref=npr-footeradmin"
                                                target="_blank"
                                                class="text-sm text-blueGray-500 font-semibold py-1 text-center md:text-left"
                                                >Copyright © 2021 Creative
                                                Tim</a
                                            >
                                        </div>
                                    </div>
